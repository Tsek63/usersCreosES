...
with tab1:
    ...
    <div id="left">
        ...
        <div class="stats-panel">
            <div class="panel-header"><div class="panel-title">Total des communes actives</div><div class="main-count">{t_dash}</div></div>
