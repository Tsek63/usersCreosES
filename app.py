            ...
            if not contacts_comm.empty:
                ...
                for ci, (cidx, ct) in enumerate(contacts_comm.iterrows()):
                    with cols_c[ci % 3]:
                        ...
                        gsm_html  = f'<a href="tel:{gsm}" style="color:#7c3aed;text-decoration:none;">{gsm}</a>' if gsm else '<span style="color:#94a3b8;">—</span>'
                        ...
                        st.markdown(
                            ...
                            f'📞&nbsp;{tel_html}<br>📱&nbsp;{gsm_html}<br>✉️&nbsp;{mail_html}'
                            f'</div></div>',
                            unsafe_allow_html=True
                        )
